...
/* Generated from ../O.Common/ioc.dbd */
...
int ioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/basil/Projects/git/BL-HVPS";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
